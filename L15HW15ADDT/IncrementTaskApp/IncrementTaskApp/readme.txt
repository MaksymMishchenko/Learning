...
Решение:
+1. Запустить метод DoIncrement() асинхронно создав новый асинхронный метод DoIncrementAsync используя ключевые слова async/await;
+2. Запустить асинхронный метод в контексте вторичного потока.