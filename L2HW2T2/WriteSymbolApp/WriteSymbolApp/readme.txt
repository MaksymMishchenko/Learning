...
- 2. В методе Main создать асинхронную задачу создав єкземпляр класса Task, передать в конструктор метод;
- 3. На экземпляре вызвать метод Start(), передать символ !;
- 4. Создать цикл while, в условии которого вызвать на экземпляре метод Wait(), в теле цикла выводить на консоль $;
